...
<Project Type="Project" LVVersion="15008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="TPP-printer-v3.3.vi" Type="VI" URL="../VIs/TPP-printer-v3.3.vi"/>
		<Item Name="xy振镜移动-v2.1.vi" Type="VI" URL="../VIs/xy振镜移动-v2.1.vi"/>
		<Item Name="z物镜移动.vi" Type="VI" URL="../VIs/z物镜移动.vi"/>
		<Item Name="图像位移2振镜偏转角.vi" Type="VI" URL="../VIs/图像位移2振镜偏转角.vi"/>
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="device variables.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/device variables.vi"/>
			<Item Name="display.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/display.vi"/>
			<Item Name="error.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/error.vi"/>
			<Item Name="getinfo.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/getinfo.vi"/>
			<Item Name="nilvaiu.dll" Type="Document" URL="nilvaiu.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="read buffer.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/read buffer.vi"/>
			<Item Name="read data.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/read data.vi"/>
			<Item Name="refresh.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/refresh.vi"/>
			<Item Name="reset variables.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/reset variables.vi"/>
			<Item Name="senddata.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/senddata.vi"/>
			<Item Name="sequence.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/sequence.vi"/>
			<Item Name="set buttons.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/set buttons.vi"/>
			<Item Name="set controller.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/set controller.vi"/>
			<Item Name="split data array.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/split data array.vi"/>
			<Item Name="test before send.vi" Type="VI" URL="../VIs/SubNPC3SG.llb/test before send.vi"/>
